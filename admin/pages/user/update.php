...
?>
<?php
$id = intval($_GET['id']); // untuk mencegah SQL Injection dasar

// Use prepared statement for select
$stmt = $conn->prepare("SELECT id, name, gender, address, phone FROM user WHERE id = ?");
