...
<body class="g-sidenav-show   bg-gray-100">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover text-center">
                ...
                while ($user_data = mysqli_fetch_array($result)) {
                  ...
                  echo "<td>
                  <a href = 'delete.php?id=$user_data[id]' class='btn btn-danger btn-sm' style='margin : 5px'>Delete</a> 
                  <a href = 'update.php?id=$user_data[id]' class='btn btn-success btn-sm'  style='margin : 5px'>Update</a>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  <div class="modal-header">
                    <h2 class="text-uppercase mb-3">Admin Detail </h2>
  ...
  <script>
    ...
    detailModal.addEventListener('show.bs.modal', function(event) {
      ...
      var modalUserAddress = detailModal.querySelector('#modalUserAddress');
