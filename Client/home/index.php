              ...
              <form method="post" action="">
                ...
                <div class="row">
                  ...
                  <div class="mb-5 col-sm-6">
                    ...
                    <input type="phone" class="form-control form-control-lg" name="phone" id="phone" placeholder="Phone">
                  </div>
                </div>
                <div class="row">
                  <div class="mb-3 col-sm-10">
                    <label for="" class="form-label">Subject</label>
                    <input type="subject" class="form-control form-control-lg" name="subject" id="subject" placeholder="subject">
                  </div>
                </div>
                <div class="row">
                  <div class="mb-3 col-sm-12">
                    <label for="message" class="form-label">Message</label>
                    <textarea name="message" id="message" class="form-control form-control-lg" placeholder="Your Message"></textarea>
                  </div>
                </div>
